...
func NewRouter(h *Handlers, allowedOrigins []string) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.POST("/documents/:id/pages/insert", h.InsertPages)
		v1.POST("/documents/:id/pages/append-from", h.AppendFrom)
		...
		v1.POST("/documents/:id/sign", h.Sign)
		v1.GET("/documents/:id/signatures", h.Signatures)
		v1.GET("/documents/:id/form", h.FormFields)
		v1.POST("/documents/:id/form", h.FillForm)
		v1.POST("/documents/:id/form/fields", h.AddFormFields)
